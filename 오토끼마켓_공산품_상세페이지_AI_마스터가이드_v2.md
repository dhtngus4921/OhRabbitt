# 오토끼마켓 공산품 상세페이지 AI 마스터 가이드 v2

> **이전 버전 안내:** 다음 상품부터는 확정 규격과 세션 인수인계 표준이 추가된 `C:\Codex\오토끼마켓_공산품_상세페이지_AI_마스터가이드_v3.md`를 사용한다.
...
- Primary Brand Color: **Otoggi Blue `#66A2D4`**
...
- Primary Brand Color: **Otoggi Blue `#66A2D4`** — 제공 JPG의 대표 픽셀값 기준
...
- 기본 정보용 본문 서체: **Pretendard**
- DISPLAY 서체: 상품 세계관에 맞게 변경 가능
- HANDWRITING / ACCENT 서체: 상품별 변경 가능하되 사용량 제한
...
- 반응형 미리보기: 작업 캔버스를 실제 모바일 뷰포트에 축소해 글자와 이미지 가독성 검수
